...
Function CreateAppShortcut
  ...
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\${LANG_APP_NAME}.lnk" "$INSTDIR\${EXE_NAME}"
  CreateShortCut "$SMPROGRAMS\${PRODUCT_NAME}\卸载${LANG_APP_NAME}.lnk" "$INSTDIR\uninst.exe"
...
Function un.DeleteShotcutAndInstallInfo
	...
	; 删除快捷方式
	SetShellVarContext all
	Delete "$SMPROGRAMS\${PRODUCT_NAME}\${LANG_APP_NAME}.lnk"
	Delete "$SMPROGRAMS\${PRODUCT_NAME}\卸载${LANG_APP_NAME}.lnk"
	RMDir "$SMPROGRAMS\${PRODUCT_NAME}\"	
	Delete "$DESKTOP\${LANG_APP_NAME}.lnk"
